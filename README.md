...
#### [5.1.1 Creating a session](use-casesreate-a-session.md)
...
#### [5.1.2 Moderating a session](use-casesoderate-a-session.md)
...
#### [5.1.3 Join a session](use-casesoin-a-session.md)
Viewers have to join the session to participate using a nick name.

#### [5.1.4 Participate in a session](use-casesarticipate-in-session.md)
